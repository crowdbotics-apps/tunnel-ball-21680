"""tunnel_ball_21680 URL Configuration
...
admin.site.site_header = "Tunnel Ball"
admin.site.site_title = "Tunnel Ball Admin Portal"
admin.site.index_title = "Tunnel Ball Admin"

# swagger
api_info = openapi.Info(
    title="Tunnel Ball API",
    default_version="v1",
    description="API documentation for Tunnel Ball App",
)
